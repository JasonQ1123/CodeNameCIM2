StartupEvents.registry("creative_mode_tab", (event) => {
	...
	addCreativeTab("io_block")
		...
		.displayName(Component.translatable(`itemGroup.${CmiCore.MODID}.io_block`))
	...
	addCreativeTab("materials")
		...
		.displayName(Component.translatable(`itemGroup.${CmiCore.MODID}.materials`))

	addCreativeTab("developers")
		.icon(() => Item.of("cmi:re_construction"))
		.content(() => Ingredient.of("#cmi:dev_doll").itemIds)
		.displayName(Component.translatable(`itemGroup.${CmiCore.MODID}.developers`))
})